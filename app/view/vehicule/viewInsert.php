    ...
    <div class="container">
        ...
        <form role="form" method='get' action='router2.php'>
            ...
            <div class="form-group">
                ...
                <label class='w-25' for="id">Marque : </label><br>
                <input type="text" name='marque' size='75' pattern="[A-Za-zÀ-ÿ\s]+" title="lettres uniquement" required> <br><br>                      

                <label class='w-25' for="id">Modèle : </label><br>
                <input type="text" name='modele' size='75' pattern="^[A-Za-z0-9 ]+$" title="lettres et/ou chiffres" required> <br><br> 

                <label class='w-25' for="id">Année : </label><br>
                <input type="number" name='annee' size='75' min="0" step="1" title="un entier > 0" required><br><br>    

                <label class='w-25' for="id">Immatriculation : </label><br>
                <input type="text" name='immatriculation' size='75' pattern="[A-Z]{2}-[0-9]{3}-[A-Z]{2}" title="AA-123-AA" required> <br><br> 

                <label class='w-25' for="id">Propriétaire : </label><br>
