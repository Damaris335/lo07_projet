...
<body>
    <div class="container">
        ...
        <p>Le trajet suivant a été clôturé :</p>
        
        <?php
        $element = $results[0];
        printf("<p>%s vers %s le %s à %s</p>", $element->getVilleDepart(), $element->getVilleArrivee(),
                $element->getDateDepart(), $element->getHeureDepart());
        ?>
