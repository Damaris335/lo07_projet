...
<body>
    <div class="container">
        ...
        <form role="form" method='get' action='router2.php'>
                ...
                <select class="form-control" name="trajet_id" id="trajet_id">
                    ...
                    foreach ($results as $trajet) {
                        printf(
                                ...
                                $trajet['id'], $trajet['depart'], $trajet['arrivee'], $trajet['date_depart'],
                                $trajet['heure_depart'], $trajet['prix']);
                    }
                    ?>
                </select><br/>
            ...
            <button class="btn btn-gris" type="submit">Réserver</button>
